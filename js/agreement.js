function renderAgreement () {
  return `
    ...
    <p>
        ...
        각 입력칸이 요구하는 형식에 맞춰 자유롭게 기입하시면 되겠습니다.<br>
        당연히, 거짓 정보를 입력하셔도 됩니다.
    </p>
    <p>
        ...
        Please feel free to fill out each form according to the format required.<br>
        Absolutely, you can fill out with fake information.
    </p>
    <div class="right">
